...
%--------------------------------------------------------------------------
\title{Taller 1: Simulación de canal binario con borrado y medición de información mutua}
...
\abstract{Se va a hacer una simulación de un canal binario con borrado codificado. Se harán mediciones y se analizarán los resultados.}
